  ...
  return (
    <aside className="sidebar">
      ...
      <div className="profile-section">
        ...
        <h2 className="name">Nexes Vision</h2>
      ...
      <div className="social-media-section">
        ...
        <div className="special-links">
          ...
          <a href="https://nexesvision.online" target="_blank" rel="noopener noreferrer" className="special-link">
            <div className="link-icon">🌐</div>
            <span className="link-text">nexesvision.online</span>
          </a>
          <a href="https://portfolio.com" target="_blank" rel="noopener noreferrer" className="special-link">
            <div className="link-icon">💼</div>
